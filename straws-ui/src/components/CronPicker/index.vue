                ...
                <div class="tabBody">
                    ...
                    <el-row>
                        <el-radio v-model="second.cronEvery" label="2">{{text.Seconds.interval[0]}}
                            <el-input-number :size="size" v-model="second.incrementIncrement" :min="1" :max="60"></el-input-number>
                            {{text.Seconds.interval[1]||''}}
                            <el-input-number :size="size" v-model="second.incrementStart" :min="0" :max="59"></el-input-number>
                            {{text.Seconds.interval[2]||''}}
                        </el-radio>
                    </el-row>
                    <el-row>
                        <el-radio class="long" v-model="second.cronEvery" label="3">{{text.Seconds.specific}}
                            <el-select :size="size" multiple v-model="second.specificSpecific">
                    ...
                    <el-row>
                        <el-radio v-model="second.cronEvery" label="4">{{text.Seconds.cycle[0]}}
                            <el-input-number :size="size" v-model="second.rangeStart" :min="1" :max="60"></el-input-number>
                            {{text.Seconds.cycle[1]||''}}
                            <el-input-number :size="size" v-model="second.rangeEnd" :min="0" :max="59"></el-input-number>
                ...
                <div class="tabBody">
                    ...
                    <el-row>
                        <el-radio v-model="minute.cronEvery" label="2">{{text.Minutes.interval[0]}}
                            <el-input-number :size="size" v-model="minute.incrementIncrement" :min="1" :max="60"></el-input-number>
                            {{text.Minutes.interval[1]}}
                            <el-input-number :size="size" v-model="minute.incrementStart" :min="0" :max="59"></el-input-number>
                            {{text.Minutes.interval[2]||''}}
                        </el-radio>
                    </el-row>
                    <el-row>
                        <el-radio class="long" v-model="minute.cronEvery" label="3">{{text.Minutes.specific}}
                            <el-select :size="size" multiple v-model="minute.specificSpecific">
                                <el-option v-for="val in 60" :key="val.index" :value="val-1">{{val-1}}</el-option>
                            </el-select>
                        </el-radio>
                    </el-row>
                    <el-row>
                        <el-radio v-model="minute.cronEvery" label="4">{{text.Minutes.cycle[0]}}
                            <el-input-number :size="size" v-model="minute.rangeStart" :min="1" :max="60"></el-input-number>
                            {{text.Minutes.cycle[1]}}
                            <el-input-number :size="size" v-model="minute.rangeEnd" :min="0" :max="59"></el-input-number>
                ...
                <div class="tabBody">
                    ...
                    <el-row>
                        <el-radio v-model="hour.cronEvery" label="2">{{text.Hours.interval[0]}}
                            <el-input-number :size="size" v-model="hour.incrementIncrement" :min="0" :max="23"></el-input-number>
                            {{text.Hours.interval[1]}}
                            <el-input-number :size="size" v-model="hour.incrementStart" :min="0" :max="23"></el-input-number>
                            {{text.Hours.interval[2]}}
                        </el-radio>
                    </el-row>
                    <el-row>
                        <el-radio class="long" v-model="hour.cronEvery" label="3">{{text.Hours.specific}}
                            <el-select :size="size" multiple v-model="hour.specificSpecific">
                    ...
                    <el-row>
                        <el-radio v-model="hour.cronEvery" label="4">{{text.Hours.cycle[0]}}
                            <el-input-number :size="size" v-model="hour.rangeStart" :min="0" :max="23"></el-input-number>
                            {{text.Hours.cycle[1]}}
                            <el-input-number :size="size" v-model="hour.rangeEnd" :min="0" :max="23"></el-input-number>
                            {{text.Hours.cycle[2]}}
                        </el-radio>
                    </el-row>
                </div>
                ...
                <div class="tabBody">
                    ...
                    <el-row>
                        <el-radio v-model="day.cronEvery" label="2">{{text.Day.intervalWeek[0]}}
                            <el-input-number :size="size" v-model="week.incrementIncrement" :min="1" :max="7"></el-input-number>
                            {{text.Day.intervalWeek[1]}}
                            <el-select :size="size" v-model="week.incrementStart">
                                <el-option v-for="val in 7" :key="val.index" :label="text.Week[val-1]" :value="val"></el-option>
                            </el-select>
                    ...
                    <el-row>
                        <el-radio v-model="day.cronEvery" label="3">{{text.Day.intervalDay[0]}}
                            <el-input-number :size="size" v-model="day.incrementIncrement" :min="1" :max="31"></el-input-number>
                            {{text.Day.intervalDay[1]}}
                            <el-input-number :size="size" v-model="day.incrementStart" :min="1" :max="31"></el-input-number>
                            {{text.Day.intervalDay[2]}}
                        </el-radio>
                    </el-row>
                    <el-row>
                        <el-radio class="long" v-model="day.cronEvery" label="4">{{text.Day.specificWeek}}
                            <el-select :size="size" multiple v-model="week.specificSpecific">
                    ...
                    <el-row>
                        <el-radio class="long" v-model="day.cronEvery" label="5">{{text.Day.specificDay}}
                            <el-select :size="size" multiple v-model="day.specificSpecific">
                    ...
                    <el-row>
                        <el-radio v-model="day.cronEvery" label="8">{{text.Day.lastWeek[0]}}
                            <el-select :size="size" v-model="day.cronLastSpecificDomDay">
                                <el-option v-for="val in 7" :key="val.index" :label="text.Week[val-1]" :value="val"></el-option>
                            </el-select>
                            {{text.Day.lastWeek[1]||''}}
                        </el-radio>
                    ...
                    <el-row>
                        <el-radio v-model="day.cronEvery" label="9">
                            <el-input-number :size="size" v-model="day.cronDaysBeforeEomMinus" :min="1" :max="31"></el-input-number>
                            {{text.Day.beforeEndMonth[0]}}
                        </el-radio>
                    </el-row>
                    <el-row>
                        <el-radio v-model="day.cronEvery" label="10">{{text.Day.nearestWeekday[0]}}
                            <el-input-number :size="size" v-model="day.cronDaysNearestWeekday" :min="1" :max="31"></el-input-number>
                            {{text.Day.nearestWeekday[1]}}
                        </el-radio>
                    </el-row>
                    <el-row>
                        <el-radio v-model="day.cronEvery" label="11">{{text.Day.someWeekday[0]}}
                            <el-input-number :size="size" v-model="week.cronNthDayNth" :min="1" :max="5"></el-input-number>
                            <el-select :size="size" v-model="week.cronNthDayDay">
                                <el-option v-for="val in 7" :key="val.index" :label="text.Week[val-1]" :value="val"></el-option>
                            </el-select>
                ...
                <div class="tabBody">
                    ...
                    <el-row>
                        <el-radio v-model="month.cronEvery" label="2">{{text.Month.interval[0]}}
                            <el-input-number :size="size" v-model="month.incrementIncrement" :min="0" :max="12"></el-input-number>
                            {{text.Month.interval[1]}}
                            <el-input-number :size="size" v-model="month.incrementStart" :min="0" :max="12"></el-input-number>
                        </el-radio>
                    </el-row>
                    <el-row>
                        <el-radio class="long" v-model="month.cronEvery" label="3">{{text.Month.specific}}
                            <el-select :size="size" multiple v-model="month.specificSpecific">
                    ...
                    <el-row>
                        <el-radio v-model="month.cronEvery" label="4">{{text.Month.cycle[0]}}
                            <el-input-number :size="size" v-model="month.rangeStart" :min="1" :max="12"></el-input-number>
                            {{text.Month.cycle[1]}}
                            <el-input-number :size="size" v-model="month.rangeEnd" :min="1" :max="12"></el-input-number>
                        </el-radio>
                    </el-row>
                </div>
            </el-tab-pane>
                ...
                <div class="tabBody">
                    ...
                    <el-row>
                        <el-radio v-model="year.cronEvery" label="2">{{text.Year.interval[0]}}
                            <el-input-number :size="size" v-model="year.incrementIncrement" :min="1" :max="99"></el-input-number>
                            {{text.Year.interval[1]}}
                            <el-input-number :size="size" v-model="year.incrementStart" :min="year.min" :max="year.min + 100"></el-input-number>
                        </el-radio>
                    </el-row>
                    <el-row>
                        <el-radio class="long" v-model="year.cronEvery" label="3">{{text.Year.specific}}
                            <el-select :size="size" filterable multiple v-model="year.specificSpecific">
                                <el-option v-for="val in 100" :key="val.index" :label="year.min + val - 1" :value="year.min + val -1"></el-option>
                            </el-select>
                        </el-radio>
                    </el-row>
                    <el-row>
                        <el-radio v-model="year.cronEvery" label="4">{{text.Year.cycle[0]}}
                            <el-input-number :size="size" v-model="year.rangeStart"  :min="year.min" :max="year.min + 100"></el-input-number>
                            {{text.Year.cycle[1]}}
                            <el-input-number :size="size" v-model="year.rangeEnd"  :min="year.min" :max="year.min + 100"></el-input-number>
                        </el-radio>
                    </el-row>
                </div>
            </el-tab-pane>
...
<script>
    ...
    computed: {
        ...
        cron(){
            return `${this.secondsText||'0'} ${this.minutesText||'0'} ${this.hoursText||'0'} ${this.daysText||'*'} ${this.monthsText||'*'} ${this.weeksText||'?'} ${this.yearsText||'*'}`
        },
    },
    methods: {
        getValue(){
