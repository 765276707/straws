    ...
    <el-container>
        ...
        <el-main>
            ...
            style="width: 100%;">
                ...
                <el-table-column prop="name"    label="数据源名" ></el-table-column>
                <el-table-column prop="typeName"    label="产品类型" ></el-table-column>
                <el-table-column prop="jdbcUrl"    label="JDBC地址"  :show-overflow-tooltip="true"></el-table-column>
                <el-table-column prop="driverClassName"    label="驱动类" ></el-table-column>
                <el-table-column prop="username"    label="数据源账号" ></el-table-column>
                <el-table-column prop="password"    label="数据源密码" ></el-table-column>
...
export default {
    ...
    methods: {
        ...
        async getPage() {
            this.loading = true
            let response = await this.$API.datasource.getPage(this.searchText)   
        ...
        deleteInRow(index, row) {
            this.$confirm('此操作删除数据源的同时也会将所有绑定该数据源的任务会被移除, 是否继续?', '危险操作', {
                ...
                this.$prompt('请输入您的密码，以确认删除', '确认删除', {
                    ...
                    this.$API.datasource.deleteAfterCheckPwd(
                        {
                            'password': value,
                            'id': row.id
                        }
